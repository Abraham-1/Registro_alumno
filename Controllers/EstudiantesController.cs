...
namespace Registro_alumno.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(RegistroAlumnoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Estudiantes != null ? 
                          ...
                          Problem("Entity set 'RegistroAlumnoContext.Estudiantes'  is null.");
        }
        ...
        public async Task<IActionResult> NotaEstudiante(int? id)
        {
            ...
            IQueryable<Nota> Nota = _context.Notas;
            Nota = Nota.Where(m => m.EstudianteId == id);

            var nota = await Nota.ToListAsync();
            if (nota == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RegistroAlumnoContext.Estudiantes'  is null.");
            }
            var estudiante = await _context.Estudiantes.FindAsync(id);
            if (estudiante != null)
            {
